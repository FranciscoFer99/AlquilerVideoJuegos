                    ...
                    <div id="formLogin" class="container border mt-3 py-4 d-flex justify-content-center" style="width: 40%">
                        <form action="" method="POST">
                            <div class ="row ">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <input type="submit" class="mt-4 btn btn-primary" name="login" value="Login">
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            foreach ($listaJuegos as $juego) {
                                ...
                                if (isset($_SESSION['usuario'])) {
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <input type="submit" class="btn btn-primary" name='alquilar' value="Alquilar" <?php if ($juego->getAlquilado() == "SI") echo 'disabled'; ?>>
                                    </form>
                                    <?php
                                    echo '</td>';
                                }
